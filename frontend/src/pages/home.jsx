const Home = () => {
  return (
    <div className="bg-marvelDark min-h-screen text-white relative flex flex-col items-center justify-center">
      <div className="absolute inset-0 bg-cover bg-center opacity-70" style={{ backgroundImage: 'url("https://i.postimg.cc/gj9y4WYc/bg-home-upscayl-3x-high-fidelity-4x.png")' }}></div>
